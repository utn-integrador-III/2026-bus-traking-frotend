...
9. **Sin atribución de IA en PRs ni commits.** Títulos, descripciones de PR y mensajes de commit **no** deben incluir el nombre ni referencia a "Claude Code" (ni a Claude/IA en general): nada de footer `🤖 Generated with Claude Code`, ni líneas `Co-Authored-By: Claude ...`, ni menciones a herramientas de IA. El contenido se redacta como propio del equipo.
