...
interface PassengerTicketScreenProps {
  ticket: Ticket;
  onBackHome: () => void;
  onBackToTrip: () => void;
}

export default function PassengerTicketScreen({
  ticket,
  onBackHome,
  onBackToTrip,
}: PassengerTicketScreenProps) {
  return (
        ...
        <View style={styles.ticketCard}>
          ...
          <View style={styles.infoGrid}>
            ...
            <View style={styles.infoBox}>
              ...
              <Text style={styles.infoValue}>{ticket.payment_type || "Mock"}</Text>
            </View>
          ...
          <View style={styles.fullRow}>
            ...
            <Text style={styles.fullRowValue}>
              {new Date(ticket.generated_at || ticket.created_at).toLocaleString()}
            </Text>
          </View>
