...
- **Sin atribución de IA en PRs ni commits.** Los títulos/descripciones de PR y los mensajes de
  commit **no** llevan el nombre ni referencia a "Claude Code" (ni a Claude/IA): nada de
  `🤖 Generated with Claude Code` ni `Co-Authored-By: Claude ...`. Esto anula la guía por defecto.
